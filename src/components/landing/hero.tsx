...
export function Hero() {
  ...
  return (
    <section className="relative flex h-[calc(100vh-4rem)] overflow-hidden bg-grid">
      <div className="bg-gradient-hero pointer-events-none absolute inset-0" />
      <div className="relative mx-auto flex h-[calc(100vh-4rem)] max-w-container items-center px-4 py-20 sm:px-6 lg:px-8">
