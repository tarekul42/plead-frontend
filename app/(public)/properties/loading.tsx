...
export default function LoadingExplore() {
  return (
    <div className="mx-auto max-w-container px-4 py-8 sm:px-6 lg:px-8">
      <div className="mb-6">
        <div className="mb-2 h-8 w-48 animate-pulse rounded bg-neutral-200 dark:bg-surface" />
        <div className="h-4 w-32 animate-pulse rounded bg-neutral-200 dark:bg-surface" />
      </div>
